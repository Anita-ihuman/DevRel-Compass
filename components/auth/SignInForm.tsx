...
export default function SignInForm({
    ...
    return (
      <div className="auth-card">
        ...
        <p className="auth-sub">
          We sent a magic sign-in link to <strong>{email}</strong>. Click it to finish signing in.
        </p>
      </div>
    )
  }
  ...
  return (
    <div className="auth-card">
      <h1 className="auth-title">Sign in to DevRel Compass</h1>
      <p className="auth-sub">Sign in or create your account — it only takes a second.</p>
      ...
      {hasOAuth && <div className="auth-divider">or</div>}
